...
public interface ApiInterface{
    ...
    Call<Envelope<UpdateProfileResponse>> updateProfile(@Body UpdateProfileRequest updateProfileRequest);
    ...
    @GET("/api/recipe")
    Call<Envelope<List<Recipe>>> doNextPage(@Query("page")int page);
    @Multipart
    @POST("/api/recipe")
